...
namespace Client.ScriptCreate
{
    ...
    public class ScriptCreater
    {
        ...
        private void AppendNoteHead(StringAppender appender, YuScriptCreateSetting setting)
        {
        ...
        private void TryAppendAotuInterface(StringAppender appender, YuScriptCreateSetting setting)
        {
