...
namespace Common
{
    ...
    /// 提供各种语言脚本创建的API封装。
    /// </summary>
    public class StringAppender : IDisposable
    {
        ...
        public static StringAppender StartAppend(string format, params object[] args)
        {
            var builder = new StringAppender();
            builder.m_Builder.AppendFormat(format, args);
            return builder;
        }

        public static StringAppender StartAppend(string format)
        {
            var builder = new StringAppender();
        ...
        public static StringAppender StartAppendLine(string value)
        {
            var builder = new StringAppender();
        ...
        public static StringAppender StartAppendLine(string format, params object[] args)
        {
            var builder = new StringAppender();
            builder.m_Builder.AppendFormat(format, args);
        ...
        public StringAppender Append(string format, params object[] args)
        {
            m_Builder.AppendFormat(format, args);
            return this;
        }

        public StringAppender Append(string format)
        {
        ...
        public StringAppender AppendRightLine(string value)
        {
            ToRight();
            AppendLine(value);
            return this;
        ...
        private StringAppender AppendLine(string value, params object[] args)
        {
            AppendSpace();
