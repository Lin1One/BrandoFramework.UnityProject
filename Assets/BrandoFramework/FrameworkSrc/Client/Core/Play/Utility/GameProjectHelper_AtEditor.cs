...
namespace Client.Core
{
    public partial class GameProjectHelper
    {
        ...
        public string CsPlayDir
        {
            get
            {
                var rootPath = ProjectInfoDati.GetActualInstance().ProjectRootDir;
        ...
        public string CsAssetIdPath
        {
            get
            {
                var path = CsPlayDir + $"{ProjectInfoDati.GetActualInstance().DevelopProjectName}_AssetId.cs";
                return path;
            }
        }
        ...
        public string AssetInfoFileName
        {
            get
            {
                var name = $"{ProjectInfoDati.GetActualInstance().DevelopProjectName.ToLower()}_assetinfos";
                return name;
            }
        }
        ...
        public string ViewMetaInfoFileName
        {
            get
            {
                var name = $"{ProjectInfoDati.GetActualInstance().DevelopProjectName.ToLower()}_viewmetainfo";
                return name;
            }
        }
        ...
        public string ViewSettingName
        {
            get
            {
                var name = ProjectInfoDati.GetActualInstance().ProjectRootDir + "_ViewSetting";
                return name.ToLower();
            }
        }
        ...
        public string Initializer_MainFilePath
        {
            get
            {
                var path = CsAppInitializerDir
                           + ProjectInfoDati.GetActualInstance().DevelopProjectName + "_Initializer_Main.cs";
                return path;
            }
        }
        ...
        public string Initializer_MapViewActionRouterPath
        {
            get
            {
                var path = CsAppInitializerDir + ProjectInfoDati.GetActualInstance().DevelopProjectName
        ...
        {
            var path = $"{ProjectInfoDati.GetActualInstance().DevelopProjectName}/Router/View/{type}Router";
            return path;
        }
        ...
        public string ViewModelRouterGetPath
        {
            get
            {
                var path = $"{ProjectInfoDati.GetActualInstance().DevelopProjectName}/Router/View/ModelRouter";
                return path;
            }
        }
        ...
        public string ViewModelStorageGetPath
        {
            get
            {
                var path = $"{ProjectInfoDati.GetActualInstance().DevelopProjectName}/Router/View/ModelStorage";
                return path;
            }
        }
        ...
        public string ViewCreatorGetPath
        {
            get
            {
                var path = $"{ProjectInfoDati.GetActualInstance().DevelopProjectName}/Creator/View/ViewCreator";
                return path;
            }
        }
        ...
        //                   + "Library/ScriptAssemblies/" + ProjectInfoDati.GetActualInstance(). + ".dll";
        //        return path;
        //    }
        //}
        ...
        //public string AssetInfoStreamingEditorPath => $"{StreamingAssetsDir}{ProjectInfoDati.GetActualInstance().DevelopProjectName + "AssetInfo.bytes"};
       //ublic string AssetInfoLocalHttpPath => $"{LocalHttpRootDir}{LocU3DApp.LocAppId}_AssetInfo.bytes";
        ...
        public string Windows64PackPath => Application.dataPath.Replace("Assets", "")
                                          + $"PackOut/{ProjectInfoDati.GetActualInstance().DevelopProjectName}/Windows64/{ProjectInfoDati.GetActualInstance().DevelopProjectName}.exe";
        public string AndroidPackPath => Application.dataPath.Replace("Assets", "")
                                  + $"PackOut/{ProjectInfoDati.GetActualInstance().DevelopProjectName}/Android/{ProjectInfoDati.GetActualInstance().DevelopProjectName}.apk";
