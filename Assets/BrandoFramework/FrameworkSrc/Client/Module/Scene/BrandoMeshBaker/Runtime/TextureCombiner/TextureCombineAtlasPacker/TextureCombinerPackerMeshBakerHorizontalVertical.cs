...
namespace GameWorld
{
    /*
        TODO test
    */
    internal class TextureCombinerPackerMeshBakerHorizontalVertical : TextureCombinerPackerMeshBaker
    {
        private interface IPipeline
        {
            PackingAlgorithmEnum GetPackingAlg();
            void SortTexSetIntoBins(MaterialPropTexturesSet texSet, List<MaterialPropTexturesSet> horizontalVert, List<MaterialPropTexturesSet> regular, int maxAtlasWidth, int maxAtlasHeight);
            TextureTilingTreatment GetEdge2EdgeTreatment();
        ...
        {
            public PackingAlgorithmEnum GetPackingAlg()
            {
                return PackingAlgorithmEnum.MeshBakerTexturePacker_Vertical;
            }
            ...
            public TextureTilingTreatment GetEdge2EdgeTreatment()
            {
                return TextureTilingTreatment.edgeToEdgeY;
            }
        ...
        private class HorizontalPipeline : IPipeline
        {
            public PackingAlgorithmEnum GetPackingAlg()
            {
                return PackingAlgorithmEnum.MeshBakerTexturePacker_Horizontal;
            }
            ...
            public TextureTilingTreatment GetEdge2EdgeTreatment()
            {
                return TextureTilingTreatment.edgeToEdgeX;
            }
        ...
        public TextureCombinerPackerMeshBakerHorizontalVertical(AtlasDirection ad)
        {
            _atlasDirection = ad;
        }
