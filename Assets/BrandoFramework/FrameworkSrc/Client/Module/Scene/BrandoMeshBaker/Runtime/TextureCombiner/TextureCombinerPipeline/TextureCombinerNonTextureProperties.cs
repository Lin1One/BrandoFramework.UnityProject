...
namespace GameWorld
{
    public class TextureCombinerNonTextureProperties
    {
        //材质球参数接口
        ...
        private interface NonTextureProperties
        {
            ...
            Texture2D TintTextureWithTextureCombiner(Texture2D t, MaterialPropTexturesSet sourceMaterial, ShaderTextureProperty shaderPropertyName);
            void AdjustNonTextureProperties(Material resultMat, List<ShaderTextureProperty> texPropertyNames, List<MaterialPropTexturesSet> distinctMaterialTextures, EditorMethodsInterface editorMethods);
        ...
        {
            TextureCombinerNonTextureProperties _textureProperties;
        ...
        TextureCombinerNonTextureProperties.MaterialProperty[] _nonTextureProperties = new TextureCombinerNonTextureProperties.MaterialProperty[]
        {
            new TextureCombinerNonTextureProperties.MaterialPropertyColor("_Color", Color.white),
            //new MB3_TextureCombinerNonTextureProperties.MaterialPropertyFloat("_Cutoff"),
            new TextureCombinerNonTextureProperties.MaterialPropertyFloat("_Glossiness", .5f),
            new TextureCombinerNonTextureProperties.MaterialPropertyFloat("_GlossMapScale", 1f),
            new TextureCombinerNonTextureProperties.MaterialPropertyFloat("_Metallic", 0f),
            ...
            new TextureCombinerNonTextureProperties.MaterialPropertyFloat("_BumpScale", .1f),
            new TextureCombinerNonTextureProperties.MaterialPropertyFloat("_Parallax", .02f),
            new TextureCombinerNonTextureProperties.MaterialPropertyFloat("_OcclusionStrength", 1f),
            new TextureCombinerNonTextureProperties.MaterialPropertyColor("_EmissionColor", Color.black),
        };
        ...
        internal void CollectAverageValuesOfNonTextureProperties(Material resultMaterial, Material mat)
        {
            ...
            {
                TextureCombinerNonTextureProperties.MaterialProperty prop = _nonTextureProperties[i];
