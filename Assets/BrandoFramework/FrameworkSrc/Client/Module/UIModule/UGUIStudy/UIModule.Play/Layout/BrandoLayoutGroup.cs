...
namespace Client.UI
{
    ...
    public abstract class BrandoLayoutGroup : BrandoUIBehaviour, ILayoutElement, ILayoutGroup
    {
        ...
        protected BrandoLayoutGroup()
        {
            if (m_Padding == null)
                m_Padding = new RectOffset();
        }

        #region Unity Lifetime calls 及 Tranc 事件
