...
namespace Client.UI
{
    [AddComponentMenu("BrandoUI/BrandoImage", 11)]
    public class BrandoUIImage : BrandoUIMaskableGraphic,
        ISerializationCallbackReceiver, 
        ILayoutElement, 
        ICanvasRaycastFilter
    {
        protected BrandoUIImage()
        {
        ...
        /// <summary>
        /// 默认 Canvas ETC1 + 透明通道材质缓存
        /// </summary>
        /// <remarks>
        /// Note: 需要 UI/DefaultETC1 Shader 
        /// </remarks>
        ...
        /// <summary>
        /// The specified Material used by this Image. 
        /// The default Material is used instead if one wasn't specified.
        /// 指定材质
        /// </summary>
        public override Material material
        {
            get
            {
                ...
                if (Application.isPlaying &&
                    activeSprite &&
                    activeSprite.associatedAlphaSplitTexture != null)
                {
        ...
        ///是否使用 sprite 导入器的生成网格
        [SerializeField]
        private bool m_UseSpriteMesh;

        /// <summary>
        /// true : use the mesh generated by the TextureImporter, 
        /// false : by a simple quad mesh.
        /// </summary>
        /// <remarks>
        /// 如果 texture 导入器的 SpriteMeshType 设置为 FullRect，则只生成一个 quad，
        /// 而不是紧密贴合的 sprite 网格
        /// </remarks>
        ...
        {
            var spriteSize = new Vector2(activeSprite.rect.width,
        ...
        /// <summary>
        /// 调整组件 RectTransform 尺寸为 sprite 大小
        /// </summary>
        ...
        private static void TrackImage(BrandoUIImage g)
        {
            if (!s_Initialized)
            {
        ...
        private static void UnTrackImage(BrandoUIImage g)
        {
        ...
        #region ICanvasRaycastFilter 接口
        ...
        #region ISerializationCallbackReceiver 接口
