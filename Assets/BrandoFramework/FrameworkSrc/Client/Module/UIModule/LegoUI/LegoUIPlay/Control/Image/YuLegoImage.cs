...
{
    [AddComponentMenu("Yu/LegoUI/YuLego Image", 2)]
    [ExecuteInEditMode]
    public class YuLegoImage :
        ...
        IYuLegoImage
    {
        ...
        public Sprite sprite
        {
            ...
            set
            {
                if (YuLegoSetPropertyUtility.SetClass(ref m_Sprite, value)) SetAllDirty();
            }
        }
        ...
        public Sprite overrideSprite
        {
            ...
            set
            {
                if (YuLegoSetPropertyUtility.SetClass(ref m_OverrideSprite, value)) SetAllDirty();
            }
        }
        ...
        public Type type
        {
            ...
            set
            {
                if (YuLegoSetPropertyUtility.SetStruct(ref m_Type, value)) SetVerticesDirty();
            }
        }
        ...
        public bool preserveAspect
        {
            ...
            set
            {
                if (YuLegoSetPropertyUtility.SetStruct(ref m_PreserveAspect, value)) SetVerticesDirty();
            }
        }
        ...
        public bool fillCenter
        {
            ...
            set
            {
                if (YuLegoSetPropertyUtility.SetStruct(ref m_FillCenter, value)) SetVerticesDirty();
            }
        }
        ...
        public FillMethod fillMethod
        {
            ...
            set
            {
                if (YuLegoSetPropertyUtility.SetStruct(ref m_FillMethod, value))
                {
                    SetVerticesDirty();
                    m_FillOrigin = 0;
                }
        ...
        public float fillAmount
        {
            ...
            set
            {
                if (YuLegoSetPropertyUtility.SetStruct(ref m_FillAmount, Mathf.Clamp01(value))) SetVerticesDirty();
            }
        }
        ...
        public bool fillClockwise
        {
            ...
            set
            {
                if (YuLegoSetPropertyUtility.SetStruct(ref m_FillClockwise, value)) SetVerticesDirty();
            }
        }
        ...
        public int fillOrigin
        {
            ...
            set
            {
                if (YuLegoSetPropertyUtility.SetStruct(ref m_FillOrigin, value)) SetVerticesDirty();
            }
        }
                ...
                if (m_FillCenter)
                {
                    ...
                    if (nVertices > 65000.0)
                    {
                        Debug.LogError(
                            ...
                            "\". The tile size will be increased. To remove the limit on the number of tiles, convert the Sprite to an Advanced texture, remove the borders, clear the Packing tag and set the Wrap mode to Repeat.",
                            this);
        ...
        {
            get => sprite == null ? null : sprite.name;
            set
            {
                ...
                sprite = SpriteRouter.GetSprite(value);
            }
        }
        ...
        public override void Metamorphose(LegoUIMeta uiMeta)
        {
            ...
            var imageMeta = uiMeta.NextImage;
            RectMeta = uiMeta.CurrentRect;
            Metamorphose(RectMeta, imageMeta);

            MetamorphoseStage = LegoMetamorphoseStage.Completed;
        }

        public void Metamorphose(LegoRectTransformMeta rectMeta, LegoImageMeta imageMeta)
        {
            YuLegoUtility.MetamorphoseRect(RectTransform, rectMeta);
            Metamorphose(imageMeta);
        }

        public void Metamorphose(LegoImageMeta meta)
        {
            TryLoadSprite(meta);

            color = meta.LegoColor.ToColor();
            type = meta.ImageType;
            raycastTarget = meta.RaycastTarget;
            preserveAspect = meta.PreserveAspect;

            TrySetFilled(meta);
        }

        private void TryLoadSprite(LegoImageMeta imageMeta)
        {
            var spriteId = imageMeta?.SpriteId;
            if (string.IsNullOrEmpty(spriteId))
            {
                return;
            }

            sprite = SpriteRouter.GetSprite(spriteId);
        }

        private void TrySetFilled(LegoImageMeta meta)
        {
            if (type != Type.Filled)
            {
                return;
            ...
            m_FillOrigin = meta.FillOriginType;
            fillAmount = meta.FillAmount;
            fillMethod = meta.FillMethod;
            fillClockwise = meta.Clockwise;
        }
        ...
        public void ReceiveSpriteChange(string newValue)
        {
