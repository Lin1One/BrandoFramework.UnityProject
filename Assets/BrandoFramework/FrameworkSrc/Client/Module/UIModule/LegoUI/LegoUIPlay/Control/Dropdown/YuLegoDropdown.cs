...
{
    [AddComponentMenu("Yu/LegoUI/YuLego Dropdown", 35)]
    [RequireComponent(typeof(RectTransform))]
    public class YuLegoDropdown :
        ...
        IYuLegoDropdown
    {
        ...
        {
            [SerializeField] private YuLegoText m_Text;
            [SerializeField] private YuLegoImage m_Image;
            [SerializeField] private RectTransform m_RectTransform;
            [SerializeField] private YuLegoToggle m_Toggle;
        ...
        {
            [SerializeField] private List<OptionData> m_Options;
        ...
        [SerializeField] private YuLegoText m_CaptionText;

        public YuLegoText captionText
        {
        ...
        [SerializeField] private YuLegoImage m_CaptionImage;

        public YuLegoImage captionImage
        {
        ...
        [Space] [SerializeField] private YuLegoText m_ItemText;

        public YuLegoText itemText
        {
        ...
        [SerializeField] private YuLegoImage m_ItemImage;

        public YuLegoImage itemImage
        {
        ...
        [Space] [SerializeField] private int m_Value;
        ...
        private YuLegoTweenRunner<YuLegoFloatTween> _mAlphaYuLegoTweenRunner;
        ...
        protected override void Awake()
        {
            ...
            _mAlphaYuLegoTweenRunner = new YuLegoTweenRunner<YuLegoFloatTween>();
            _mAlphaYuLegoTweenRunner.Init(this);
        ...
        private void SetupTemplate()
        {
            ...
            YuLegoToggle itemToggle = m_Template.GetComponentInChildren<YuLegoToggle>();
        ...
        public void Show()
        {
            ...
            // Get root Canvas.
            var list = YuLegoListPool<Canvas>.Get();
            gameObject.GetComponentsInParent(false, list);
            if (list.Count == 0)
                return;
            Canvas rootCanvas = list[0];
            YuLegoListPool<Canvas>.Release(list);
            ...
            Vector2 offsetMin = itemTemplateRect.min - dropdownContentRect.min +
                                (Vector2)itemTemplate.rectTransform.localPosition;
            Vector2 offsetMax = itemTemplateRect.max - dropdownContentRect.max +
                                (Vector2)itemTemplate.rectTransform.localPosition;
            Vector2 itemSize = itemTemplateRect.size;

            m_Items.Clear();

            YuLegoToggle prev = null;
            for (int i = 0; i < options.Count; ++i)
            {
            ...
            if (extraSpace > 0)
                dropdownRectTransform.sizeDelta = new Vector2(dropdownRectTransform.sizeDelta.x,
        ...
        private DropdownItem AddItem(OptionData data, bool selected, DropdownItem itemTemplate,
        ...
        private void AlphaFadeList(float duration, float start, float end)
        {
            ...
            YuLegoFloatTween tween = new YuLegoFloatTween { duration = duration, startValue = start, targetValue = end };
            tween.AddOnChangedCallback(SetAlpha);
            tween.ignoreTimeScale = true;
            _mAlphaYuLegoTweenRunner.StartTween(tween);
        }
        ...
        private void OnSelectItem(YuLegoToggle toggle)
        {
            if (!toggle.isOn)
                toggle.isOn = true;
        ...
        private Action<int> m_PushAction;
        ...
        public void BindingPush(Action<int> pushAction) => m_PushAction = pushAction;

        public void ReceiveValueChange(int v) => value = v;
        ...
        private YuLegoImage SelfImage
        {
            get
            {
                ...
                selfImage = GetComponent<YuLegoImage>();
                return selfImage;
            }
        }

        private YuLegoText label;
        ...
        private YuLegoText Label
        {
            get
            {
                ...
                label = RectTransform.Find("Label")
                    .GetComponent<YuLegoText>();
                return label;
            }
        }

        private YuLegoImage arrow;
        ...
        private YuLegoImage Arrow
        {
            get
            {
                ...
                arrow = RectTransform.Find("Arrow")
                    .GetComponent<YuLegoImage>();
                return arrow;
            }
        }

        private YuLegoImage templateImage;
        ...
        private YuLegoImage TemplateImage
        {
            get
            {
                ...
                templateImage = m_Template.GetComponent<YuLegoImage>();
                return templateImage;
            }
        }

        private YuLegoImage viewportImage;
        ...
        private YuLegoImage ViewportImage
        {
            get
            {
                ...
                viewportImage = m_Template.Find("Viewport")
                    .GetComponent<YuLegoImage>();
                return viewportImage;
            }
        }
        ...
        private RectTransform Content
        {
            get
            {
                ...
                content = viewportImage.RectTransform.Find("Content")
                    .GetComponent<RectTransform>();
                return content;
            }
        }

        private YuLegoToggle item;
        ...
        private YuLegoToggle Item
        {
            get
            {
                ...
                item = Content.Find("Item").GetComponent<YuLegoToggle>();
                return item;
            }
        }

        private YuLegoImage itemBackground;
        ...
        private YuLegoImage ItemBackground
        {
            get
            {
                ...
                itemBackground = Item.RectTransform.Find("Item Background")
                    .GetComponent<YuLegoImage>();
                return itemBackground;
            }
        }

        private YuLegoImage itemCheckmark;
        ...
        private YuLegoImage ItemCheckmark
        {
            get
            {
                ...
                itemCheckmark = Item.RectTransform.Find("Item Checkmark")
                    .GetComponent<YuLegoImage>();
                return itemCheckmark;
            }
        }

        private YuLegoText itemLabel;

        public YuLegoText ItemLabel
        {
            get
            {
                if (itemLabel != null)
                ...
                itemLabel = Item.RectTransform.Find("Item Label")
                    .GetComponent<YuLegoText>();
                return itemLabel;
            }
        }

        private YuLegoImage scrollbarImage;
        ...
        private YuLegoImage ScrollbarImage
        {
            get
            {
                ...
                scrollbarImage = TemplateImage.RectTransform
                    .Find("Scrollbar").GetComponent<YuLegoImage>();
                return scrollbarImage;
            }
        }
        ...
        private RectTransform SlidingArea
        {
            get
            {
                ...
                slidingArea = ScrollbarImage.RectTransform
                    .Find("Sliding Area").GetComponent<RectTransform>();
                return slidingArea;
            }
        }

        private YuLegoImage hanldeImage;
        ...
        private YuLegoImage HandleImage
        {
            get
            {
                ...
                hanldeImage = SlidingArea
                    .Find("Handle").GetComponent<YuLegoImage>();
                return hanldeImage;
            }
        }
        ...
        private LegoDropdownMeta dropdownMeta;
        private LegoRectTransformMeta dropdownRectMeta;
