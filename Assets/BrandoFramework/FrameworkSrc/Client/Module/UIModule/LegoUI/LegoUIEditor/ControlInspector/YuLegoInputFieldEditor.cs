...
namespace Client.LegoUI.Editor
{
    ...
    [CustomEditor(typeof(YuLegoInputField), true)]
    public class YuLegoInputFieldEditor : SelectableEditor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            {
                YuLegoText text = m_TextComponent.objectReferenceValue as YuLegoText;
