...
{
    public class ExcelCsharpInterfaceScriptCreator : ExcelScriptCreatorBase
    {
        public override ScriptType ScriptType => ScriptType.Csharp;
        public override string ScriptName => ExcelUtilty.EntityInterfaceName(projectInfo, SheetInfo);
