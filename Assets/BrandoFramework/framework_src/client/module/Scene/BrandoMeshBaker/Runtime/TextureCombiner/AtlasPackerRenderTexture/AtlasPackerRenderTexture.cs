...
namespace GameWorld
{
    public class TextureCombinerRenderTexture
    {
        ...
        Rect[] rs;
        List<MaterialPropTexturesSet> textureSets;
        int indexOfTexSetToRender;
        ShaderTextureProperty _texPropertyName;
        TextureCombinerNonTextureProperties _resultMaterialTextureBlender;
        Texture2D targTex;
    ...
    [ExecuteInEditMode]
    public class AtlasPackerRenderTexture : MonoBehaviour
    {
        TextureCombinerRenderTexture fastRenderer;
        bool _doRenderAtlas = false;
        ...
        public TextureCombinerNonTextureProperties resultMaterialTextureBlender;
        public Rect[] rects;
        public Texture2D tex1;
        public List<MaterialPropTexturesSet> textureSets;
        ...
        public Texture2D OnRenderAtlas(TextureCombineHandler combiner)
        {
            fastRenderer = new TextureCombinerRenderTexture();
            _doRenderAtlas = true;
            Texture2D atlas = fastRenderer.DoRenderAtlas(this.gameObject, 
                width, 
                height, 
                padding, 
                rects, 
                textureSets, 
                indexOfTexSetToRender, 
                texPropertyName, 
