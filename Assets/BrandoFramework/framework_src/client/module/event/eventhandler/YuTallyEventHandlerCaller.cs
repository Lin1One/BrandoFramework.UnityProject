...
namespace client_module_event
{
    ...
    public class YuTallyEventHandlerCaller : ITallyEventHandlerCaller
    {
        ...
        public int AddHandler(Action eventAction, int executeCount = -1)
        {
            ...
            var handler = new YuTallyEventHandler(executeCount, eventAction);
    ...
    public class YuTallyEventHandlerCaller<TData> : ITallyEventHandlerCaller<TData>
    {
        ...
        {
            var handler = new TallyEventHandler<TData>(executeCount, eventAction);
            m_Handlers.Add(handler);
            return handler.Id;
        }
