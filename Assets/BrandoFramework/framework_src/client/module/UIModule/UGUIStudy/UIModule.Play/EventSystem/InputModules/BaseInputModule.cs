...
namespace Client.UI.EventSystem
{
    ...
    /// 输入模块基类
    /// </summary>
    [RequireComponent(typeof(BrandoEventSystem))]
    public abstract class BaseInputModule : BrandoUIBehaviour
    {
        /// <summary>
        /// 射线结果缓存
        /// </summary>
        ...
        private BrandoEventSystem m_EventSystem;
        protected BrandoEventSystem eventSystem
        {
