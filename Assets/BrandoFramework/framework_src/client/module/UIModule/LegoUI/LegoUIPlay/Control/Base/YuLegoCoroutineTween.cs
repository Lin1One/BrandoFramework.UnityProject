...
namespace Client.LegoUI
{
    ...
    internal struct ColorTween : ITweenValue
    {
        ...
        public class YuLegoColorTweenCallback : UnityEvent<Color>
        {
        }

        private YuLegoColorTweenCallback m_Target;
        ...
        {
            if (m_Target == null)
                m_Target = new YuLegoColorTweenCallback();
    ...
    // TweenValue callback and then sets
    // the value on the target.
    internal struct YuLegoFloatTween : ITweenValue
    {
    ...
    // behaviour container.
    internal class YuLegoTweenRunner<T> where T : struct, ITweenValue
    {
