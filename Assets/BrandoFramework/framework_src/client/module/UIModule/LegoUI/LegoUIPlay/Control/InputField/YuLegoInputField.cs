...
namespace Client.LegoUI
{
    ...
    /// </summary>
    [AddComponentMenu("Yu/LegoUI/YuLego Input Field", 31)]
    public class YuLegoInputField :
        ...
        IYuLegoInputField
    {
        ...
        protected YuLegoText m_TextComponent;
        ...
        {
            set { YuLegoSetPropertyUtility.SetStruct(ref m_HideMobileInput, value); }
            get
            {
        ...
        {
            get { return Application.platform != RuntimePlatform.tvOS; }
        }
        ...
        public string text
        {
            ...
            set
            {
                ...
                {
                    m_Text = characterLimit > 0 && value.Length > characterLimit
        ...
        public float caretBlinkRate
        {
            ...
            set
            {
                if (YuLegoSetPropertyUtility.SetStruct(ref m_CaretBlinkRate, value))
                {
                    if (m_AllowInput)
                        SetCaretActive();
                }
        ...
        public int caretWidth
        {
            ...
            set
            {
                if (YuLegoSetPropertyUtility.SetStruct(ref m_CaretWidth, value)) MarkGeometryAsDirty();
            }
        }

        public YuLegoText textComponent
        {
            ...
            set
            {
                ...
                if (YuLegoSetPropertyUtility.SetClass(ref m_TextComponent, value))
                {
                    EnforceTextHOverflow();
                    if (m_TextComponent != null)
                    {
        ...
        public Graphic placeholder
        {
            ...
            set { YuLegoSetPropertyUtility.SetClass(ref m_Placeholder, value); }
        }
        ...
        public Color caretColor
        {
            ...
            set
            {
                if (YuLegoSetPropertyUtility.SetColor(ref m_CaretColor, value)) MarkGeometryAsDirty();
            }
        }
        ...
        public Color selectionColor
        {
            ...
            set
            {
                if (YuLegoSetPropertyUtility.SetColor(ref m_SelectionColor, value)) MarkGeometryAsDirty();
            }
        }
        ...
        public SubmitEvent onEndEdit
        {
            ...
            set { YuLegoSetPropertyUtility.SetClass(ref m_OnEndEdit, value); }
        }
        ...
        public OnChangeEvent onValueChanged
        {
            ...
            set { YuLegoSetPropertyUtility.SetClass(ref m_OnValueChanged, value); }
        }

        public OnValidateInput onValidateInput
        {
            get { return m_OnValidateInput; }
            set { YuLegoSetPropertyUtility.SetClass(ref m_OnValidateInput, value); }
        }
        ...
        public int characterLimit
        {
            ...
            set
            {
                if (YuLegoSetPropertyUtility.SetStruct(ref m_CharacterLimit, Math.Max(0, value))) UpdateLabel();
            }
        }
        ...
        public ContentType contentType
        {
            ...
            set
            {
                if (YuLegoSetPropertyUtility.SetStruct(ref m_ContentType, value)) EnforceContentType();
            }
        }
        ...
        public LineType lineType
        {
            ...
            set
            {
                if (YuLegoSetPropertyUtility.SetStruct(ref m_LineType, value))
                {
        ...
        public InputType inputType
        {
            ...
            set
            {
                if (YuLegoSetPropertyUtility.SetStruct(ref m_InputType, value)) SetToCustom();
            }
        }
        ...
        public TouchScreenKeyboardType keyboardType
        {
            ...
            set
            {
                ...
                //        Debug.LogWarning(
                //            "Invalid InputField.keyboardType value set. TouchScreenKeyboardType.NintendoNetworkAccount only applies to the Wii U. InputField.keyboardType will default to TouchScreenKeyboardType.Default .");
                //}
#elif !UNITY_WIIU
                if (value == TouchScreenKeyboardType.NintendoNetworkAccount)
                    Debug.LogWarning(
                        "Invalid InputField.keyboardType value set. TouchScreenKeyboardType.NintendoNetworkAccount only applies to the Wii U. InputField.keyboardType will default to TouchScreenKeyboardType.Default .");
#endif
                if (YuLegoSetPropertyUtility.SetStruct(ref m_KeyboardType, value))
                    SetToCustom();
            }
        }
        ...
        public CharacterValidation characterValidation
        {
            ...
            set
            {
                if (YuLegoSetPropertyUtility.SetStruct(ref m_CharacterValidation, value)) SetToCustom();
            }
        }
        ...
        public char asteriskChar
        {
            ...
            set
            {
                if (YuLegoSetPropertyUtility.SetStruct(ref m_AsteriskChar, value)) UpdateLabel();
            }
        }
        ...
        protected override void OnEnable()
        {
            ...
            if (m_CachedInputRenderer != null)
                m_CachedInputRenderer.SetMaterial(m_TextComponent.GetModifiedMaterial(Graphic.defaultGraphicMaterial),
        ...
        public virtual void OnDrag(PointerEventData eventData)
        {
            ...
            RectTransformUtility.ScreenPointToLocalPointInRectangle(textComponent.rectTransform, eventData.position,
            ...
            m_DragPositionOutOfBounds = !RectTransformUtility.RectangleContainsScreenPoint(textComponent.rectTransform,
        ...
        public override void OnPointerDown(PointerEventData eventData)
        {
            ...
            if (hadFocusBefore)
            {
                ...
                caretSelectPositionInternal =
                    caretPositionInternal = GetCharacterIndexFromPosition(localMousePos) + m_DrawStart;
            }
        ...
        private void GenerateHightlight(VertexHelper vbo, Vector2 roundingOffset)
        {
            ...
            while (currentChar <= endChar && currentChar < gen.characterCount)
            {
                if (currentChar == lastCharInLineIndex || currentChar == endChar)
                {
                    ...
                    Vector2 endPosition =
                        new Vector2((endCharInfo.cursorPos.x + endCharInfo.charWidth) / m_TextComponent.pixelsPerUnit,
        ...
        private Action<string> m_PushAction;
        private YuLegoText placeholderText;
        ...
        private YuLegoText PlaceHolderText
        {
            get
            {
                ...
                placeholderText = placeholder.GetComponent<YuLegoText>();
                return placeholderText;
            }
        }
        ...
        private void OnValueChanged(string content)
        {
            if (content == "")
            {
                // 说明输入框文本已全部删除，需要激活占位提示文本控件。
                PlaceHolderText.gameObject.SetActive(true);
            }

            m_PushAction?.Invoke(content);
        ...
        private IYuLegoImage backgroundImage;

        public IYuLegoImage BackGroundImage
        {
            get
            {
                ...
                backgroundImage = GetComponent<IYuLegoImage>();
                return backgroundImage;
            }
        }

        private MetamorphoseStatus _metamorphoseStatus;
        private LegoInputFieldMeta inputFieldMeta;
        ...
        public override void Metamorphose(LegoUIMeta uiMeta)
        {
            ...
            if (inputFieldMeta == null)
            {
                inputFieldMeta = uiMeta.NextInputField;
                RectMeta = uiMeta.CurrentRect;
            }

            switch (_metamorphoseStatus)
            {
                case MetamorphoseStatus.InputField:
                    MetamorphoseRect(RectMeta);
                    if (inputFieldMeta.Transition == LegoTransition.ColorTint)
                    {
                        var colorTintMeta = inputFieldMeta.ColorTintMeta;
                    ...
                    SoundEffectId = inputFieldMeta.InputSoundId;

                    _metamorphoseStatus = MetamorphoseStatus.InputFieldImage;
                    break;
                case MetamorphoseStatus.InputFieldImage:
                    BackGroundImage.As<YuLegoImage>().Metamorphose(inputFieldMeta.RootImageMeta);
                    _metamorphoseStatus = MetamorphoseStatus.PlaceHolderText;
                    break;
                case MetamorphoseStatus.PlaceHolderText:
                    PlaceHolderText.Metamorphose(inputFieldMeta.PlaceHolderTextRectMeta,
                        inputFieldMeta.PlaceHolderTextMeta);
                    _metamorphoseStatus = MetamorphoseStatus.ContentText;
                    break;
                case MetamorphoseStatus.ContentText:
                    textComponent.Metamorphose(inputFieldMeta.ContentTextRectMeta,
                        inputFieldMeta.ContentTextMeta);

                    inputFieldMeta = null;
                    _metamorphoseStatus = MetamorphoseStatus.InputField;
        ...
        public void BindingPush(Action<string> pushAction)
        {
            m_PushAction = pushAction;
        }

        public void ReceiveContentChange(string value)
        {
            Text = value;
        }

        public void ReceiveBackgroundChange(string value)
        {
            BackGroundImage.SpriteId = value;
        }
