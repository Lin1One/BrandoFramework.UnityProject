...
namespace Sirenix.OdinInspector.Editor
{
    ...
    {
        private static string DemoFolder { get { return "Assets/" + SirenixAssetPaths.SirenixPluginPath + "Demos/"; } }
                    ...
                    Sections = new Section[]
                    {
                        ...
                        new Section()
                        {
                            ...
                            Cards = new Card[]
                            {
                                ...
                                {
                                    Title =                 "RPG Editor",
                                    Description =           "This project showcases how you can use Odin Editor Windows, Odin Selectors, various attribute combinations, and custom " +
                        ...
                        new Section()
                        {
                            ...
                            OnInspectorGUI = (window) =>
                            {
                                EditorGUILayout.BeginVertical(OdinGettingStartedWindow.cardStylePadding);
                                GUILayout.Label(
                                    "We really hope you enjoy using Odin - be sure to contact us if you have any questions or issues. " +
                                    "Finally, if you find the time, please leave a review on the Asset Store, that helps us out a lot!",
                                    SirenixGUIStyles.MultiLineCenteredLabel);
                                GUILayout.Space(10);
                                GUILayout.BeginHorizontal();
                                GUILayout.FlexibleSpace();
                                if (GUILayout.Button("      Leave a review on the Asset Store      ", GUILayout.Height((int)ButtonSizes.Large)))
                                {
