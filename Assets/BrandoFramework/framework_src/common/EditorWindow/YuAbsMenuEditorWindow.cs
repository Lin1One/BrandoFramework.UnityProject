...
{
    public abstract class YuAbsMenuEditorWindow : OdinMenuEditorWindow
    {
    ...
    public abstract class YuAbsMenuEditorWindow<T> : YuAbsMenuEditorWindow
        where T : YuAbsMenuEditorWindow
    {
        ...
        {
            var sizeAttr = typeof(T).GetAttribute<YuEditorWindowSizeAttribute>();
        ...
        {
            var titleAttr = typeof(T).GetAttribute<YuEditorWindowTitleAttribute>();
            Instance.titleContent = new GUIContent(titleAttr.Title);
        }

        protected List<IYuMenuEditorWindowItemBuilder> Builders { get; private set; }
        ...
        protected override void OnEnable()
        {
            ...
            Builders = YuMenuItemBuilderFactory.GetBuilders(windowType);
