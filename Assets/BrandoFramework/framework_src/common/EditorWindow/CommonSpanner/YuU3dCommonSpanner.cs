...
namespace Common.EditorWindow
{
    ...
    /// </summary>
    [Serializable]
    public class YuU3dCommonSpanner
    {
        #region 构造方法

        public YuU3dCommonSpanner()
        {
        ...
        private void ShowCreateSingleDatiMenu()
        {
            ...
            foreach (var datiDesc in YuU3dCommonSpannerUtility.SingleDescs)
            {
        ...
        [BoxGroup("预编译配置")] [HideLabel] public YuU3dPreComplieSetting PreComplieSetting;
        ...
        private BuildTargetGroup AsBuildTargetGroup(YuU3dBuildTargetGroup yuBuildTargetGroup)
        {
