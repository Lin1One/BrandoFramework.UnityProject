...
{
	std::ifstream fin("BookSourceAsset/Chapter 6 Drawing in Direct3D/Skull/Models/skull.txt");
	
	if(!fin)
	{
		MessageBox(0, L"BookSourceAsset/Chapter 6 Drawing in Direct3D/Skull/Models/skull.txt not found.", 0, 0);
		return;
	}
...
{
	std::ifstream fin("BookSourceAsset/Chapter 6 Drawing in Direct3D/fx/color.fxo", std::ios::binary);
