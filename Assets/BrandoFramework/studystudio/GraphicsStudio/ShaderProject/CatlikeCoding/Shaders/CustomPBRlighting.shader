...
Shader "GraphicsStudio/PBRlighting"
{
    Properties
    {
    ...
    SubShader {
        ...
        Pass {
            ...
            float TrowbridgeReitzAnisotropicNormalDistribution(float anisotropic, float NdotH, 
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                FresnelFunction *=
                SphericalGaussianFresnelFunction(LdotH, specColor);
