...
namespace GraphicsStudio.PostProcessing
{
    ...
    public sealed class DepthOfFieldComponent : PostProcessingComponentRenderTexture<DepthOfFieldModel>
    {
        ...
        const string k_RTName_CoC = "DOF_Coc_RT";
        ...
        public void Prepare(RenderTexture source, Material uberMaterial, bool antialiasCoC, Vector2 taaJitter, float taaBlending)
        {
            ...
            var colorFormat = RenderTextureFormat.Default;
            ...
            var rtCoC = context.renderTextureFactory.Get(context.width / 2, context.height / 2, 0, cocFormat, RenderTextureReadWrite.Linear, "DepthOfFieldComponent_RTCOC");
            rtCoC.name = k_RTName_CoC;
            ...
            var rt1 = context.renderTextureFactory.Get(context.width / 2, context.height / 2, 0, colorFormat, "DepthOfFieldComponent_RT1");
            material.SetTexture(Uniforms._CoCTex, rtCoC);
            Graphics.Blit(source, rt1, material, 2);

            // Bokeh simulation pass
            var rt2 = context.renderTextureFactory.Get(context.width / 2, context.height / 2, 0, colorFormat, "DepthOfFieldComponent_RT2");
        ...
        public override void OnDisable()
        {
            ...
            if (main != null)
            {
                main.depthTextureMode &= (~GetCameraFlags());
            }
        }
    }
}
