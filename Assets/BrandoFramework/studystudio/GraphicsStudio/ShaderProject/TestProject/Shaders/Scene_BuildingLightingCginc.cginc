#ifndef SCENEBUILDINGLIGHT_SHADER
#define SCENEBUILDINGLIGHT_SHADER

#include "UnityCG.cginc"
#include "Lighting.cginc"
#include "AutoLight.cginc"
#include "UnityPBSLighting.cginc"
#include "StandardLightingCginc.cginc"
...
inline half4 ScenePerPixelWorldNormal(vertexOutput vertextO, half2 uv)
{
	...
	half3 normalWorld = normalize(tangent * normalTangent.x + 
