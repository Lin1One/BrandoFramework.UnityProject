#ifndef __SCENESTANDSPECULAR_BASE_SHADER__
#define __SCENESTANDSPECULAR_BASE_SHADER__
...
#include "EzfunStandardSpecular.cginc"
...
//inline FragmentCommonData SceneSpecularSetup(float4 i_tex, half3 diffRGB, half3 specColor)
inline FragmentCommonData SceneSpecularSetup(half4 i_tex, half3 diffRGB, half3 specColor)
{
	half2 uv = i_tex.xy;
	half oneMinusReflectivity = 1 - SpecularStrength(specColor);
	half3 diffColor = diffRGB * oneMinusReflectivity;
...
inline FragmentCommonData SceneElementFragmentSetup(vertexOutput vertextO, out half emisScale)
{
...
#endif // __SCENESTANDSPECULAR_BASE_SHADER__